...
function emailRegistrationCreated() {
  return {
    'subject': "AV21 - Potvrzení registrace a detaily platby",
    'textPlain': 'Milá účastnice / milý účastníku,\n\n' +
      'úspěšně jsme zpracovali tvoji registraci na Absolventský Velehrad 2021.\n\n' +
      ...
      'Budeme velmi vděční za dobrovolné příspěvky na realizaci AV21, které můžeš zaslat na účet 2700062738/2010 s variabilním symbolem 102 nebo předat osobně na místě v průběhu setkání.\n\n' + plainTextSignature(),
    'textHtml': htmlHeader('templateAV2_allok.jpg') + '<h1>Milá účastnice / milý účastníku,</h1>' +
      pStart() + 'úspěšně jsme zpracovali tvoji registraci na Absolventský Velehrad 2021.' + pEnd() +
      ...
      pStart() +
      'Budeme velmi vděční za dobrovolné příspěvky na realizaci AV21, které můžeš zaslat na účet 2700062738/2010 s variabilním symbolem 102 nebo předat osobně na místě v průběhu setkání.' + pEnd() + htmlSignature() + htmlFooter()
  };
}

function emailPaymentArrived() {
  return {
    'subject': 'AV21 - Potvrzení platby',
    'textPlain': 'Milý účastníku / milá účastnice,\n\n' +
      'potvrzujeme, že tvoje platba dorazila na náš účet. Už se na tebe těšíme.\n\n' +
      'Registrace na AV21 bude probíhat ve čtvrtek 13. 5. 2021 od 17 do 20 hodin v poutním a exercičním domě Stojanov na Velehradě. ' +
      'Vezmi si s sebou občanský průkaz.\n\n' +
      'Při registraci na místě dostaneš veškeré potřebné informace o AV21 i o ubytování. Pokud jsi ještě nebyl/a na Velehradě ' +
    ...
    'textHtml': htmlHeader('templateAV2_pay.jpg') + '<h1>Milý účastníku / milá účastnice,</h1>' +
      ...
      pStart() + 'Registrace na AV21 bude probíhat <b>ve čtvrtek 13. 5. 2019 od 17 do 20 hodin</b> v poutním a exercičním domě Stojanov ' +
        'na Velehradě. Vezmi si s sebou občanský průkaz.' + pEnd() +
      pStart() + 'Při registraci na místě dostaneš veškeré potřebné informace o AV21 i o ubytování. Pokud jsi ještě nebyl/a na Velehradě ' +
...
function emailPaymentReminder() {
  return {
    'subject': 'AV21 - Zapomenutá platba?',
    'textPlain': 'Milý účastníku / milá účastnice,\n\n' +
      ...
      'Pokud se pořád chystáš na AV21, tak prosím pošli platbu co nejdřív. ' +
    ...
    'textHtml': htmlHeader('templateAV2_warning.jpg') + '<h1>Milý účastníku / milá účastnice,</h1>' +
      ...
      pStart() + 'Pokud se pořád chystáš na AV21, tak prosím pošli platbu co nejdřív. ' +
...
function emailRegistrationCancelled() {
  return {
    'subject': 'AV21 - Zrušená registrace',
    'textPlain': 'Milý účastníku / milá účastnice,\n\n' +
...
function plainTextSignature() {
  return '\n\nNovinky najdeš na webu www.absolventskyvelehrad.cz. Sleduj taky Facebook a Instagram. V případě změny nebo dotazů nás kontaktuj na e-mailu tym.realizace@absolventskyvelehrad.cz.\n' +
      '\n' +
      'Tématem AV21 je „Co je cíl?“. Inspiruj se příběhy obyčejně neobyčejných lidí, kteří se rozhodli nepromarnit svůj život.\n' +
      '\n' +
      'Díky a těšíme se na setkání\n' +
      '\n' +
      'Za přípravný tým AV21\n' +
      'Anička a Jakub\n';
}
...
function htmlSignature() {
  return pStart() +
      ...
      pStart() + 'Za přípravný tým AV21<br>Anička a Jakub' + pEnd();
}
...
'<head> <meta charset="utf-8"> <meta http-equiv="X-UA-Compatible" content="IE=edge"> <title>AV21 email</title> <meta name="viewport" content="width=device-width, initial-scale=1"> <!-- <link href="https://fonts.googleapis.com/css?family=Muli" rel="stylesheet"> --> <style type="text/css"> @media screen {'+
